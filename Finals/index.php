...
<body>
    <nav class="navbar navbar-expand-lg bg-light py-3">
        <div class="container">
            <a class="navbar-brand fw-bolder fs-2" href="#">PRINCESS TOUCH</a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                    ...
                    <button class="shop-btn mt-3">Shop Now</button>
                </div>

                <div class="col-lg-6 d-flex gap-3 justify-content-center">
                    <div>
                        <img src="images/model1.jpg" alt="Main model" class="img-fluid mb-3"
                            style="width:300px; height:500px">
                    </div>
                    <div class="d-flex flex-column gap-3">
                        <img src="images/model2.jpg" alt="Model 2" class="img-fluid" style="width:180px; height:240px">
                        <img src="images/model3.jpg" alt="Model 3" class="img-fluid" style="width:180px; height:240px">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-3 col-md-4 mb-4 mb-lg-0">
                    <img src="images/model6.jpg" alt="Left Image" class="img-fluid side-img">
                </div>
                ...
                <div class="col-lg-6 col-md-8">
                    ...
                    <button class="shop-btn mt-3 mb-5">Explore more</button>
                </div>

                <div class="col-lg-3 col-md-4 mb-4 mb-lg-0">
                    <img src="images/model7.jpg" alt="Right Image" class="img-fluid side-img">
                </div>
            ...
            <div class="row justify-content-center g-5">
                ...
                <div class="col-md-5">
                    <div class="card-overlay">
                        <img src="images/model4.jpg" class="img-fluid" alt="Our Mission">
                ...
                <div class="col-md-5">
                    <div class="card-overlay">
                        <img src="images/model5.jpg" class="img-fluid" alt="Our Vision">
                        <div class="overlay-content">
                            <h3>Our Vision</h3>
            ...
            <div class="row text-center justify-content-center g-4 py-5">
                <div class="col-md-3 col-sm-6">
                    <div class="product-card p-3 rounded">
                        <img src="images/Best1.png" alt="Product 1" class="img-fluid mb-3">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-card p-3 rounded">
                        <img src="images/Best2.png" alt="Product 2" class="img-fluid mb-3">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-card p-3 rounded">
                        <img src="images/Best3.png" alt="Product 3" class="img-fluid mb-3">
        ...
        <div class="container">
            <div class="row align-items-center rounded bg-light-pink p-4">
                ...
                <div class="col-md-6 text-center">
                    <img src="images/watchmodel2.jpg" alt="Model" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="best-arrivals py-5 mt-4">
        <div class="container">
            ...
            <div class="row text-center justify-content-center g-4 py-5">
                <div class="col-md-3 col-sm-6">
                    <div class="product-card p-3 rounded">
                        <img src="images/arrival1.png" alt="Product 1" class="img-fluid mb-3">
                        <h6 class="fw-semibold">Soft Pinch Dewy Liquid Blush Mini</h6>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-card p-3 rounded">
                        <img src="images/arrival2.png" alt="Product 2" class="img-fluid mb-3">
                        <h6 class="fw-semibold">New Vinopure Purifying Gel Cleanser</h6>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-card p-3 rounded">
                        <img src="images/arrival3.png" alt="Product 3" class="img-fluid mb-3">
                        <h6 class="fw-semibold">Vanish Seamless Finish Foundation Brush</h6>
            ...
            <div class="row text-center justify-content-center g-4 mt-2">
                <div class="col-md-3 col-sm-6">
                    <div class="product-card p-3 rounded">
                        <img src="images/arrival4.png" alt="Product 4" class="img-fluid mb-3">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-card p-3 rounded">
                        <img src="images/arrival5.png" alt="Product 5" class="img-fluid mb-3">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-card p-3 rounded">
                        <img src="images/arrival6.png" alt="Product 6" class="img-fluid mb-3">
    ...
    <section class="seasonal-tips py-5">
        <div class="container">
            ...
            <div class="row justify-content-center g-5">
                <div class="col-md-5">
                    <div class="card-overlay">
                        <img src="images/skintips.jpg" class="img-fluid" alt="Skin Care Tips">
                        <div class="overlay-content">
                ...
                <div class="col-md-5">
                    <div class="card-overlay">
                        <img src="images/skintips2.jpg" class="img-fluid" alt="Skin Care Tips 2">
                        <div class="overlay-content">
                            <h3>Skin Care Tips</h3>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 mb-4 mb-lg-0">
                    <img src="images/lastmodel.jpg" alt="FAQ Model" class="img-fluid rounded-4 shadow-sm">
                </div>
